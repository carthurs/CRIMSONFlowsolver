...
namespace Seldon
{
  ...
  */
  template <class T, class Prop, class Storage, class Allocator>
  inline void Matrix_ComplexSparse<T, Prop, Storage, Allocator>::Nullify()
  {
    this->data_ = NULL;
    this->m_ = 0;
    this->n_ = 0;
  ...
  */
  template <class T, class Prop, class Storage, class Allocator>
  inline typename Matrix_ComplexSparse<T, Prop, Storage, Allocator>
  ::value_type&
  ...
  */
  ...
  Matrix<T, Prop, ColComplexSparse, Allocator>::Matrix():
  ...
  */
  template <class T, class Prop, class Allocator>
  Matrix<T, Prop, RowComplexSparse, Allocator>::Matrix():
