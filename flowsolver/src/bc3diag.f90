...
!----------------------------------------------------------------------
!
! This routine satisfies the BC of the diagonal vector for 3D elements.
!
! input:
...
! if iBC=40  bits of ibc =00101000 => ibits(4,3,3)=5
! if iBC=40  bits of ibc =00101000 => ibits(4,3,2)=1
!
