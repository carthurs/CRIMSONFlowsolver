...
enum parameter_controller_t {Controller_Null, Controller_LeftVentricularElastance, Controller_BleedResistance, Controller_BleedCompliance, Controller_CustomPythonComponentParameter, Controller_CustomPythonComponentFlow, Controller_CustomPythonNode};
