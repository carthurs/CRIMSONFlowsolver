...
!
!.. The calculation of the direction of a vertex is based on the average of
!.. the normals of the neighbor faces(3); And the calculation of the direction
!.. of the edge is based on the neighbor faces(2);
!
...
!
            ...
            lDir(e,4,3) = fct * (x14*(y12 - y13) - x12*y14 + x13*y14 &
                               + x24*y23 - x23*y24)
!
!.... edge modes (quadratic and cubic)
!
            lDir(e,5,1) = pt25*(-(y13*z12) + y14*z12 + y12*(z13-z14))
            lDir(e,5,2) = pt25*(x13*z12 - x14*z12 + x12*(-z13 + z14))
            lDir(e,5,3) = pt25*(-(x13*y12) + x14*y12 + x12*(y13 - y14))
