...
//
// write relative velocity to restart file, 
// to do: replace these with a generic append_restart function KDL
// 

extern "C"
{
    void Write_Relative_Velocity(  
                  int* pid, 
                  int* stepno, 
                  int* nshg, 
                  int* numVars,
        ...
        iarray[ 1 ] = (*numVars);
        iarray[ 2 ] = (*stepno);
        writeheader_( &irstou, "relative velocity", (void*)iarray, &nitems, &isize, "double", outpar.iotype );
                    
        nitems = (*nshg)*(*numVars);
        writedatablock_( &irstou, "relative velocity", (void*)(array1), &nitems, "double", outpar.iotype );
