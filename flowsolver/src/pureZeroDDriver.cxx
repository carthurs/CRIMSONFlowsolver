...
void PureZeroDDriver::init()
{
	...
	m_zeroDDomainLPN = boost::shared_ptr<Netlist3DDomainReplacement> (new Netlist3DDomainReplacement(numberOfNetlistsUsedAsBoundaryConditions, oneResistanceToGiveEachResistor, elastanceToGiveVolumeTrackingPressureChamber, initialDomainPressure, m_hstep, m_alfi, m_delt));
