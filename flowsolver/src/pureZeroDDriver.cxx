...
void PureZeroDDriver::init()
{
	...
	assert(m_netlistDownstreamCircuitsExistHasBeenSet); //\todo do we actually need this bool available in this class? If not, remove it and its setter.
...
void PureZeroDDriver::setNetlistDownstreamCircuitsExistence(const int numLoopClosingNetlistCircuits)
{
	if (numLoopClosingNetlistCircuits > 0)
	{
		m_netlistDownstreamCircuitsExist = true;
	}
	else
	{
		m_netlistDownstreamCircuitsExist = false;
	}

	m_netlistDownstreamCircuitsExistHasBeenSet = true;
}
