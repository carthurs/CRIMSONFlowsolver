...
inflowSurfaceFaker = """# List of components in a format similar to that for netlist.
# Hash-commented lines are ignored.
### Begin zero-th netlist boundary condition model
...
3 prescribedPeriodicFlow aorticInflowPrescriber
...
netlistFile.write(inflowSurfaceFaker)
